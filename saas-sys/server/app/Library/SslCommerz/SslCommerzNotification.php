...
class SslCommerzNotification extends AbstractSslCommerz
{
    ...
    {
        $this->successUrl = rtrim(env('SSL_APP_URL'), '/') . $this->config['success_url'];
    }
    ...
    {
        $this->failedUrl = rtrim(env('SSL_APP_URL'), '/') . $this->config['failed_url'];
    }
    ...
    {
        $this->cancelUrl = rtrim(env('SSL_APP_URL'), '/') . $this->config['cancel_url'];
    }
    ...
    {
        $this->ipnUrl = rtrim(env('SSL_APP_URL'), '/') . $this->config['ipn_url'];
    }
