...
import { CancelRequestTable } from "src/sections/cancel-request/cancel-request-table";
import { FeatureSearch } from "src/sections/feature/feature-search";
import { featurDeleteApiCall, fetchCancelRequestListAPIGet,fetchSubscriptionAPIGet } from "../../common/apiCall/api";
import { FEATURE,CANCEL_REQUEST } from "../../common/constantData/language";
...
const handleClose = () => {
  ...
  return (
    <>
      ...
      <Head>
        <title>
          <title>{CANCEL_REQUEST.TITLE}</title>
        </title>
      </Head>
      {loading === false?(
        <Box
        ...
        <Container maxWidth="xl">
          <Stack spacing={3}>
            <Stack direction="row" justifyContent="space-between" spacing={4}>
              <Stack spacing={1}>
                <Typography variant="h5" sx={{marginLeft:"10px"}}>{CANCEL_REQUEST.TITLE}</Typography>
              </Stack>
