...
import {
  ownProfileDetailsAPIGet,
  ownOrganizationUpdateApiCall,
...
const Page = (props) => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    email: Yup.string().required(OWNORGANIZATION.REQUIRED.EMAIL),
    mobile: Yup.string().required(OWNORGANIZATION.REQUIRED.PHONE),
                          ...
                          <Form encType="multipart/form-data">
                            <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                              ...
                              <Grid item xs={6}>
                                <div>
                                  <label style={{ fontSize: "16px", fontFamily: "-apple-system" }}>
                                    {OWNORGANIZATION.EMAIL} <span style={{ color: "red" }}>*</span>
                                  </label>
                              ...
                              <Grid item xs={6}>
                                <div>
                                  <label style={{ fontSize: "16px", fontFamily: "-apple-system" }}>
                                    {OWNORGANIZATION.ONAME} <span style={{ color: "red" }}>*</span>
                                  </label>
                              ...
                              <Grid item xs={6}>
                                <div>
                                  <label style={{ fontSize: "16px", fontFamily: "-apple-system" }}>
                                    {OWNORGANIZATION.OEMAIL} <span style={{ color: "red" }}>*</span>
                                  </label>
