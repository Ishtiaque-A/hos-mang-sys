          ...
          <Table>
            <TableHead>
              <StyledTableRow style={{ backgroundColor: "#f2f2f2" ,borderBottom:"1px solid #F1F1F1"}}>
                ...
                <StyledTableCell>{HISTORY.Subscription}</StyledTableCell>
                <StyledTableCell>{HISTORY.PRICE}</StyledTableCell>
                <StyledTableCell>{HISTORY.AMOUNT}</StyledTableCell>
                <StyledTableCell>{HISTORY.DATE}</StyledTableCell>
                <StyledTableCell>{HISTORY.STATUS}</StyledTableCell>
                <StyledTableCell>{HISTORY.ACTION}</StyledTableCell>
              </StyledTableRow>
            </TableHead>
            <TableBody>
              {data?.data?.map((Request, index) => {
                ...
                // const createdAt = format(Request?.created_at, 'dd/MM/yyyy');
                return (
                  <TableRow hover key={Request.id} >
                    ...
                    <TableCell>
                      <Stack alignItems="center" direction="row" spacing={2}>
                       ...
                       {Request.purchase.subscription_plan.name}
                        </Typography>
                      </Stack>
                    </TableCell>
                    <TableCell>
                      <Typography variant="caption">
                      {Request.purchase.subscription_plan.price}{" "}{props.currency}
                      </Typography>
                    </TableCell>
                    <TableCell>
                      <Typography variant="caption" sx={{ color: "#9DA4AE" }}>
                      {Request.amount} {" "}{props.currency}
                      </Typography>
                    </TableCell>
                    <TableCell>
                      <Typography variant="caption" sx={{ color: "#9DA4AE" }}>
                      {Request.created_at ? format(new Date(Request.created_at), 'dd/MM/yyyy') : 'N/A'}
                      </Typography>
                    </TableCell>
                    <TableCell>
                    {
                    ...
                    <TableCell>
                      ...
                      >
                        ...
                        >
                          <Link
                            href={`${ADMIN.HISTORY_URL}/${activeItem.id}`}
                            style={{ textDecoration: "none", color: "#9DA4AE", fontSize: "14px" }}
                          >
                            {HISTORY.DETAILS}
