...
import { USER, SUBSCRIPTION_PLAN } from "../../common/constantData/language";
//change//
          ...
          <Table>
            <TableHead>
              ...
              >
                ...
                <StyledTableCell>{USER.USER_BRANCH}</StyledTableCell>
                <StyledTableCell>{USER.STATUS}</StyledTableCell>
                <StyledTableCell>{USER.ACTION}</StyledTableCell>
              </StyledTableRow>
            </TableHead>
            <TableBody>
              {data?.data?.map((user, index) => {
                const isSelected = isRowSelected(user.id);
                  ...
                  <TableRow hover key={user.id}>
                    ...
                    <TableCell sx={{ color: "#9DA4AE", textDecoration: "none" }}>
                      <Link
                        ...
                        href={`${ADMIN.USER_EDIT_URL}/${user.id}`}
                      >
                        {actualIndex}
                      </Link>
                    </TableCell>
