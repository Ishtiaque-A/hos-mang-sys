...
function EditCnSeven(props) {
    ...
    useEffect(() => {
        ...
        axios.get(`/edit-cn9/${lastpart}`).then(res => {
    ...
    const updatecnSeven = (e) => {
        ...
        const data = cnSeven;
        axios.post(`/update-cn9/${lastpart}`, data).then(res => {
            if (res.data.status === 200) {
                    ...
                    <div className="col-md-9 mt-2">
                        <div className="card">
                            <div className="card-header">
                                <h6 className="card-title"> Edit CN-IX, X
                                    <Link to={'/cn9'} className="btn btn-primary btn-sm float-end"> Back </Link>
                                </h6>
                            </div>
