...
function AddAbnormalBreathing() {
  ...
  formData.append(
    "abnormalbreathing_name",
    abnormalbreathing.abnormalbreathing_name
  );
              ...
              <div className="card">
                <div className="card-header">
                  <h6 className="card-title">
                    {" "}
                    Add Abnormal Breathing
                    <Link
                      to={"/abnormal-breathing"}
                    ...
                    <div className="card-body">
                      <div className="col-md-12">
                        <div className="form-group">
                          ...
                          <input
                            type="text"
                            value={abnormalbreathing.abnormalbreathing_name}
                            className="form-control"
                            name="abnormalbreathing_name"
                            onChange={handleInput}
                          />
                          <span className="text-danger">
                            {
                              abnormalbreathing.error_list
                                .abnormalbreathing_name
                            }
                          </span>
                        </div>
                        <div>
                          ...
                          <select
                            id="inputState"
                            onChange={handleInput}
                            value={abnormalbreathing.status_id}
                            name="status_id"
                            ...
                            {statuslist.map((item) => {
                              return (
                                <option value={item.id} key={item.id}>
                                  {item.history_exam_status_name}
                                </option>
                              );
                            })}
                          </select>
                          <span className="text-danger">
                            {abnormalbreathing.error_list.status_id}
                          </span>
                        </div>
                        ...
                        <div className="form-group mt-3">
                          <label
                            htmlFor="history_name"
                            className="col-form-label-sm mt-1  "
                          >
                            <b className="me-3">Selection </b>
                          </label>
                        ...
                        <span className="text-danger">
                          {abnormalbreathing.error_list.selection_criteria}
                        </span>
