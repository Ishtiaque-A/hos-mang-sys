...
const AddPostOpertive = () => {
    ...
    const handleInput =(e)=> {
        setPostOperativeName({
            ...postOperativeName, [e.target.name]:e.target.value
        })
    }
    ...
    //  }
     ...
     axios.post('/save-post-operative-name',postOperativeName)
     .then(res => {
                                        ...
                                        <div className="card-body">
                                            <div className="col-md-12">
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" className="form-control" value={postOperativeName.name} name="name" onChange={handleInput}/>
                                                    <span className="text-danger">{postOperativeName.error_list.name}</span>
                                                </div>
