...
const AddProcedureName = () => {
    ...
    const handleInput=(e)=>{
        setProcedureName({
            ...procedureName,[e.target.name]:e.target.value
        });
     };
    ...
    //  }
     ...
     axios.post('/save-procedure-report-name',procedureName)
     .then(res => {
                                        ...
                                        <div className="card-body">
                                            <div className="col-md-12">
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" value={procedureName.name} className="form-control" name="name" onChange={handleInput}/>
                                                    <span className="text-danger">{procedureName.error_list.name}</span>
                                                </div>
