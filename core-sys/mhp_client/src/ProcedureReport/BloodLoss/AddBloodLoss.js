...
const AddBloodLossName = () => {
    ...
    const handleInput=(e)=>{
        setBloodLossName({
            ...bloodLossName,[e.target.name]:e.target.value
        });
     };
    ...
    //  }
     ...
     axios.post('/save-blood-loss-name',bloodLossName)
     .then(res => {
                                    ...
                                    <div className="card-body">
                                        <div className="col-md-12">
                                            <div className="form-group">
                                                ...
                                                <input type="text" value={bloodLossName.name} className="form-control" name="name" onChange={handleInput}/>
                                                <span className="text-danger">{bloodLossName.error_list.name}</span>
                                            </div>
