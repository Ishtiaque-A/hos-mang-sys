...
export default function LabMarketerReport() {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .post(`great-lab-billing-report-marketer`, filter)
      .then((res) => {
  ...
  const handleFilter = () => {
    ...
    axios
      .post(`great-lab-billing-report-marketer`, modifiedData)
      .then((res) => {
        setData(res?.data?.invoice || []);
        setAllData(res?.data || {});
      })
        ...
        <div className="custom-card p-2">
          <div className="row">
            <div className={isSuperAdmin ? "col-4 d-flex" : "col-5 d-flex"}>
              ...
              <div
                style={{ width: isSuperAdmin ? "200px" : "300px" }}
              ...
              >
                <ReactSearchAutocomplete
                  ...
                  onSelect={(item) => {
                    setFilter({ ...filter, marketer: item?.id });
                  }}
                  maxResults={3}
                  fuseOptions={{
                    keys: ["name"],
