...
const PrintGreatLabInvoice = ({
  ...
  const totalDiscount = parseFloat(discount_percentage) / 100 * totalBill;
        ...
        <div className="row  mt-3 mb-1">
          <div className="row col-8">
            <div className="col-6 d-flex align-items-center">
              {slipTitle !== "Preview Mode" && <p className="p-0 m-0">
                Invoice No:
        ...
        <div className="invoice-item-table">
          <table>
            ...
            <tr>
              ...
              <td className="text-end">
                ({discount_percentage}%) {formatNumber(parseFloat(totalDiscount))}
              </td>
            </tr>

            <tr className="invoice-border-dashed-top">
              <td colSpan={1} className="text-end">
                {slipTitle === "Refund Slip" ? "Total Refund:" : "Bill Total :"}
              </td>
              <td className="text-end">
...
export default PrintGreatLabInvoice;
