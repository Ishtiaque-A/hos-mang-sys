...
function PaediatricPage24(props) {
    ...
    const [visionTestValue, setvisionTestValue] = useState([]);

    console.log(visionTestValue)
    ...
    return (
        <>
            <div ref={refPE1} className='bg-white py-3 px-5 rounded-3' style={{ overflowX: 'none' }}>
                <div className=''>
                                ...
                                <div className="ms-1">
                                    <label className="switch me-1">
                                        <input
                                            ...
                                            type="checkbox"
                                            onChange={(e) => {
                                                setChange4(!change4); setvisionTest("")
                                                setvisionTestValue([])
                                            }}
                                            id="togBtn"
                                        />
                                        <div onClick={(e) => setAnchorEl4(e.currentTarget)} className="slider round"></div>
                                        {
                                            ...
                                            >
                                                ...
                                                <div className="left-popup">
                                                    <div className="row">
                                                        <div className="col-sm-6">   <div className="form-check ms-1">
                                                            <input className="form-check-input" value="Right" type="radio" name="result_vision_chart" onChange={(e) => { setvisionTest(e.target.value) }} id="flexRadioDefault1" />
                                                            <label className="form-check-label">
                                                                Right
                                                            </label>
                                                            <input className="form-check-input" value="left" type="radio" name="result_vision_chart" onChange={(e) => { setvisionTest(e.target.value) }} id="flexRadioDefault1" />
                                                            <label className="form-check-label">
                                                                Left
                                                            </label>
                                                            <input className="form-check-input" value="both" type="radio" name="result_vision_chart" onChange={(e) => { setvisionTest(e.target.value) }} id="flexRadioDefault1" />
                                                            <label className="form-check-label">
                                                                both
                                                            </label>
                                                        ...
                                                        <div className="col-sm-6">   <div className="form-check ms-1">
                                                            <input className="form-check-input" value="Amblyopia (lazy eye)" type="checkbox" onChange={(e) => {
                                                                const { value, checked } = e.target;
                                                                if (checked) {
                                                                    setvisionTestValue([...visionTestValue, value])
                                                                } else {
                                                                    let data = visionTestValue.filter(item => item !== value)
                                                                    setvisionTestValue(data)
                                                                }
                                                            }} id="flexRadioDefault1" />
                                                            <label className="form-check-label">
                                                                Amblyopia (lazy eye)
                                                            </label>
                                                            <input className="form-check-input" value="Strabismus (eye turn)" type="checkbox" onChange={(e) => {
                                                                const { value, checked } = e.target;
                                                                if (checked) {
                                                                    setvisionTestValue([...visionTestValue, value])
                                                                } else {
                                                            ...
                                                            <input className="form-check-input" value="Nearsightedness" type="checkbox" onChange={(e) => {
                                                                const { value, checked } = e.target;
                                                                if (checked) {
                                                                    setvisionTestValue([...visionTestValue, value])
                                                                } else {
                                                            ...
                                                            <input className="form-check-input" value="Farsightedness" type="checkbox" onChange={(e) => {
                                                                const { value, checked } = e.target;
                                                                if (checked) {
                                                                    setvisionTestValue([...visionTestValue, value])
                                                                } else {
                                                            ...
                                                            <input className="form-check-input" value="Astigmatism" type="checkbox" onChange={(e) => {
                                                                const { value, checked } = e.target;
                                                                if (checked) {
                                                                    setvisionTestValue([...visionTestValue, value])
                                                                } else {
                                            ...
                                            >
                                                ...
                                                <div className="left-popup">
                                                    <div className="form-check ms-1">
                                                        <input className="form-check-input" value="right eye normal" type="radio" name="result_vision_chart" onChange={(e) => { setResultVisionChart(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            right eye normal
                                                        </label>
                                                        <input className="form-check-input" value="left eye normal" type="radio" name="result_vision_chart" onChange={(e) => { setResultVisionChart(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Left eye normal
                                                        </label>
                                                        <input className="form-check-input" value="both eye normal" type="radio" name="result_vision_chart" onChange={(e) => { setResultVisionChart(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            both eye normal
                                                        </label>
                                                        <input className="form-check-input" value="Abnormal" type="radio" name="result_vision_chart" onChange={(e) => { setResultVisionChart(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Abnormal
                                                        </label>
                                    ...
                                    <label className="switch me-1">
                                        ...
                                        <div onClick={(e) => setAnchorEl6(e.currentTarget)} className="slider round"></div>
                                        {
                                            ...
                                            >
                                                ...
                                                <div className="left-popup">
                                                    <div className="form-check ms-1">
                                                        <input className="form-check-input" value="right eye  normal" type="radio" name="result_vision" onChange={(e) => { setVisionChart(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            right eye  normal
                                                        </label>
                                                        <input className="form-check-input" value="left eye  normal" type="radio" name="result_vision" onChange={(e) => { setVisionChart(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            left eye  normal
                                                        </label>
                                                        <input className="form-check-input" value="both eye  normal" type="radio" name="result_vision" onChange={(e) => { setVisionChart(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            both eye  normal
                                                        </label>
                                                        <input className="form-check-input" value="Abnormal" type="radio" name="result_vision" onChange={(e) => { setVisionChart(e.target.value) }} id="flexRadioDefault1" />
                                                        <label className="form-check-label">
                                                            Abnormal
                                                        </label>
            ...
            <div className='pedriatric_btn'>
                ...
                {btnLoading ? <button className='pedriatric_btn_middle'>Loading...</button> : <button className='pedriatric_btn_middle' onClick={handleSave}>Save</button>}
