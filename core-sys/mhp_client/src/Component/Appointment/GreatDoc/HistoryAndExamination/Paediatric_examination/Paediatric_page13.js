...
function PaediatricPage13(props) {
    ...
    return (
        <>
            <div ref={refPE1} className='bg-white p-4 rounded-3' style={{ overflowX: 'none' }}>
                <div className=''>
                    <h5 className='pb-1'><b>Child health check 6 months  </b> </h5>
                </div>
                <h6>Assessment by child and family health nurse, GP or pediatrician.</h6>
                                                ...
                                                >
                                                    ...
                                                    <div className="left-popup d-flex">
                                                        <div className="form-check ms-1">
                                                            ...
                                                            <input className="form-check-input" value="both" type="radio" name="fully_descended_option1" onChange={(e) => { setfullyDescended(e.target.value) }} id="flexRadioDefault1" />
                                                            <label className="form-check-label">
                                                                both
                                                            </label>
