...
const Skin = (props) => {
    ...
    useEffect(() => {
        ...
        axios.get(`/commonHistory-all/Dermatology`, { signal: controller.signal }).then(res => {
            setHistory(res.data.commonHistory)
            setHistorySort(res.data.commonHistory)
        });

        axios.get(`/skin-shape`, { signal: controller.signal }).then(res => {
            if (res.data.status === 200) {
                setshapeArray(res.data.SkinShape);
            }
        });

        axios.get(`/color`, { signal: controller.signal }).then(res => {
            if (res.data.status === 200) {
        ...
        axios.get(`/palpation`, { signal: controller.signal }).then(res => {
            if (res.data.status === 200) {
                setpalpationArray(res.data.Palpation);
            }
        });
        axios.get(`/temparature`, { signal: controller.signal }).then(res => {
            if (res.data.status === 200) {
                settemparatureArray(res.data.Temparature);
            }

        });
        axios.get(`/arrangements`, { signal: controller.signal }).then(res => {
            if (res.data.status === 200) {
        ...
        axios.get(`/areolar`, { signal: controller.signal }).then(res => {
            if (res.data.status === 200) {
        ...
        axios.get(`/skin-type`, { signal: controller.signal }).then(res => {
            if (res.data.status === 200) {
        ...
        axios.get(`/skin-symptoms`, { signal: controller.signal }).then(res => {
            if (res.data.status === 200) {
    ...
    useEffect(() => {
        ...
        return () => { cancelSub = true }
    }, []);

    const [active, setActive] = useState();
    const [activeBack, setActiveBack] = useState("");
    const [sympImage, setSympImage] = useState([]);
    const [sympImageError, setSympImageError] = useState(null);
    const handleSympImageUrl = (event) => {
        if (event.target.files[0].size < 2000000) {
            const images = [...sympImage]
            images.push({
            ...
            setSympImage(images)
            setSympImageError(null)
        } else {
            setSympImageError("File size must be less than 2 mb !")
        }
    ...
    const addSymptom = (symp, index) => {
        ...
        newSymptom.push({ symp: symp.name, bodyPart: active });
        ...
        axios.post('save-skin-examination', data).then(res => {
            ...
            sympImage.map((item) => {
                ...
                axios.post('save-skin-examination-images', formData).then(res => {
                    sympImageRes.push({ img: res.data.data.image, bodyPart: res.data.data.bodyPart_name })
            ...
            symptoms.map((item) => {
                ...
                formData.append('skin_exami_id', res.data.Skin.id);
                formData.append('bodyPart_name', item.bodyPart);
                formData.append('symptom_id', item.symp);
                axios.post('save-skin-examination-syntoms', formData).then(res => {
                    sympNameRes.push({ name: res.data.data.symptom_id, bodyPart: res.data.data.bodyPart_name })
...
<p class="MsoNormal" style="margin: 0in 0in 0px ; font-family: Arial, sans-serif; line-height: 180%; font-size: 15px;">
    <span style="font-family: Roboto; color: rgb(54, 54, 54);"><strong>Skin: 
    ${sympImageRes.map((item, i) => {
                    return (
                        `&nbsp; &nbsp;<img src="${global.img_url}/images/skinExmi/${item.img}" alt="" width="80" height="85">`
                    )
                }).join('')}
    </strong></span></p>
<p class="MsoNormal" style="margin: 0in 0in 0px ; font-size: 15px; font-family: Arial, sans-serif; line-height: 180%;">
    <strong><span style="font-family: Roboto; color: rgb(54, 54, 54);">${res.data.Skin.historyValue ? "History:" : ""}</span></strong></p>

<p class="MsoNormal" style="margin: 0in 0in 0px; font-family: Arial, sans-serif; line-height: 180%; font-size: 15px;">
    <span style="font-family: Roboto; color: rgb(54, 54, 54);"><span style="font-size: 15px;">
    ${res.data.Skin.historyValue.replaceAll(',', ' . ')}</span></span></p>

    ${sympNameRes.length === 0 ? '' :
                        `
<p class="MsoNormal" style="margin: 0in 0in 0px; font-family: Arial, sans-serif; line-height: 180%; font-size: 15px;">
    <span style="font-family: Roboto; color: rgb(54, 54, 54);"><span style="font-size: 15px;">
    Symptoms:  ${sympNameRes.map((item, i) => {
                            return (
                                `${item.name}`
                            )
                        }).join(' . ')}
...
<p class="MsoNormal" style="margin: 0in 0in 0px ; font-size: 15px; font-family: Arial, sans-serif; line-height: 180%;">
    <strong><span style="font-family: Roboto; color: rgb(54, 54, 54);">${(res.data.Skin.acute || res.data.Skin.chronic || res.data.Skin.duration || res.data.Skin.stable || res.data.Skin.growing) ? "Rash:" : ""} </span></strong></p>

<p class="MsoNormal" style="margin: 0in 0in 0px; font-family: Arial, sans-serif; line-height: 180%; font-size: 15px;">
    <span style="font-family: Roboto; color: rgb(54, 54, 54);"><span style="font-size: 15px;">
    ${res.data.Skin.acute === false ? `` : `Acute Onset. `}
    ${res.data.Skin.chronic === false ? `` : `Chronic Onset. `}
    ${res.data.Skin.duration === null ? `` : `Duration: ${res.data.Skin.duration} ${res.data.Skin.durationType === null ? `` : res.data.Skin.durationType} . `}
    ${res.data.Skin.stable === false ? `` : ` Stable not growing .`}
    ${res.data.Skin.growing === false ? `` : ` Growing and spreading`}
</span></span></p>

${(res.data.Skin.site || res.data.Skin.neck || res.data.Skin.scapula || res.data.Skin.upperBack || res.data.Skin.lowerBack || res.data.Skin.chestLower || res.data.Skin.chestUpper || res.data.Skin.arm || res.data.Skin.forearm || res.data.Skin.hand || res.data.Skin.finger || res.data.Skin.interdigital || res.data.Skin.nail || res.data.Skin.areolar || res.data.Skin.mammary || res.data.Skin.abdomen || res.data.Skin.umbilical || res.data.Skin.groin || res.data.Skin.buttock || res.data.Skin.perineal || res.data.Skin.thigh || res.data.Skin.leg || res.data.Skin.knee || res.data.Skin.foot) ? `<p class="MsoNormal" style="margin: 0in 0in 0px ; font-size: 15px; font-family: Arial, sans-serif; line-height: 180%;">
    <strong><span style="font-family: Roboto; color: rgb(54, 54, 54);">Site : </span></strong></p>

<p class="MsoNormal" style="margin: 0in 0in 0px; font-family: Arial, sans-serif; line-height: 180%; font-size: 15px;">
    <span style="font-family: Roboto; color: rgb(54, 54, 54);"><span style="font-size: 15px;">
    ${res.data.Skin.site === null ? `` : `Site : </span></span><u>${res.data.Skin.site}</u><span style="font-size: 15px;"> .`}
    ${res.data.Skin.neck === null ? `` : `Neck : </span></span><u>${res.data.Skin.neck}</u><span style="font-size: 15px;"> . `}
    ${res.data.Skin.scapula === false ? `` : `Scapula . `}
    ${res.data.Skin.upperBack === false ? `` : `Upper Back . `}
    ${res.data.Skin.lowerBack === false ? `` : `Lower Back . `}
    ${res.data.Skin.chestLower === false ? `` : `Chest Lower . `}
    ${res.data.Skin.chestUpper === false ? `` : `Chest Upper . `}
    ${res.data.Skin.arm === null ? `` : `Arm : </span></span><u>${res.data.Skin.arm}</u><span style="font-size: 15px;"> . `}
    ${res.data.Skin.forearm === null ? `` : `Forearm : </span></span><u>${res.data.Skin.forearm}</u><span style="font-size: 15px;"> . `}
    ${res.data.Skin.hand === null ? `` : `Hand : </span></span><u>${res.data.Skin.hand}</u><span style="font-size: 15px;"> . `}
    ${res.data.Skin.finger === false ? `` : `Finger . `}
    ${res.data.Skin.interdigital === false ? `` : `Interdigital . `}
    ${res.data.Skin.nail === false ? `` : `Nail . `}


    ${res.data.Skin.areolar === null ? `` : `Areolar : </span></span><u>${res.data.Skin.areolar}</u><span style="font-size: 15px;"> .`}
    ${res.data.Skin.mammary === false ? `` : `Sub Mammary . `}
    ${res.data.Skin.abdomen === false ? `` : `Abdomen . `}
    ${res.data.Skin.umbilical === false ? `` : `Umbilical . `}
    ${res.data.Skin.inguinal === false ? `` : `Inguinal . `}
    ${res.data.Skin.groin === false ? `` : `Groin . `}
    ${res.data.Skin.buttock === false ? `` : `Buttock . `}
    ${res.data.Skin.perineal === false ? `` : `Perineal . `}
    ${res.data.Skin.thigh === null ? `` : `Thigh : </span></span><u>${res.data.Skin.thigh}</u><span style="font-size: 15px;"> . `}
    ${res.data.Skin.leg === null ? `` : `Leg : </span></span><u>${res.data.Skin.leg}</u><span style="font-size: 15px;"> . `}
    ${res.data.Skin.knee === null ? `` : `Knee : </span></span><u>${res.data.Skin.knee}</u><span style="font-size: 15px;"> . `}
    ${res.data.Skin.foot === null ? `` : `Foot : </span></span><u>${res.data.Skin.foot}</u><span style="font-size: 15px;"> . `}
    ${res.data.Skin.interdigitalSpace === null ? `` : `Interdigital Space `}
</span></span></p>` : ""}
...
${res.data.Skin.type === "" ? `` :
                        `<p class="MsoNormal" style="margin: 0in 0in 0px; font-family: Arial, sans-serif; line-height: 180%; font-size: 15px;">
    <span style="font-family: Roboto; color: rgb(54, 54, 54);"><span style="font-size: 15px;">
    Type : </span></span><u>${res.data.Skin.type.replaceAll(',', ' . ')}</u><span style="font-size: 15px;"> .
</span></span></p>
`}
${res.data.Skin.size1 === null ? `` :
                        `<p class="MsoNormal" style="margin: 0in 0in 0px; font-family: Arial, sans-serif; line-height: 180%; font-size: 15px;">
    <span style="font-family: Roboto; color: rgb(54, 54, 54);"><span style="font-size: 15px;">
    Size : </span></span><u>${res.data.Skin.size1} mm * ${res.data.Skin.size2} mm</u><span style="font-size: 15px;"> .
</span></span></p>`}
${(res.data.Skin.shape || res.data.Skin.color || res.data.Skin.palpation || res.data.Skin.temparature || res.data.Skin.arrangements) ? `< p class= "MsoNormal" style = "margin: 0in 0in 0px; font-family: Arial, sans-serif; line-height: 180%; font-size: 15px;" >
                <span style="font-family: Roboto; color: rgb(54, 54, 54);"><span style="font-size: 15px;">
                    ${res.data.Skin.shape === null ? `` : `Shape: </span></span><u>${res.data.Skin.shape}</u><span style="font-size: 15px;"> . `}
                    ${res.data.Skin.color === null ? `` : `Color: </span></span><u>${res.data.Skin.color}</u><span style="font-size: 15px;"> . `}
                    ${res.data.Skin.palpation === null ? `` : `Palpation: </span></span><u>${res.data.Skin.palpation}</u><span style="font-size: 15px;"> . `}
                    ${res.data.Skin.temparature === null ? `` : `Temperature: </span></span><u>${res.data.Skin.temparature}</u><span style="font-size: 15px;"> . `}
                    ${res.data.Skin.arrangements === null ? `` : `Arrangements: </span></span><u>${res.data.Skin.arrangements}</u><span style="font-size: 15px;"> . `}
                </span></span></p > ` : ""}
                    ...
                    <div className="d-flex">
                        ...
                        <div className="w-50">
                            <button onClick={() => {
                                ...
                                setspiner(true)
                            }} class="vaital-setup-btn-cancel float-end">Reset</button>
                            {
                                saveLoading ?
                ...
                <div className="row">
                    <div className="col-lg-7">
                        <div className="row">
                                                        ...
                                                        <div onClick={(e) => setAnchorEl1(e.currentTarget)} className="slider round"></div>
                                                        {
                                                            ...
                                                            >
                                                                <div className="left-popup">
                                                                    ...
                                                                    <div className="form-check ms-1">
                                                                        <input className="form-check-input" value="Both" type="radio" name="right" onChange={(e) => { setSite(e.target.value) }} id="flexRadioDefault1" />
                                                                        <label className="form-check-label" >
                                                                            Both
                                                                        </label>
                                                                    </div>
                            ...
                            <div className="col-4 col-lg-6">
                                <div className="show-skin-site mt-lg-2 p-1">
                                    <div className="exam-bg-white p-1 mt-2">
                                        <div className="d-flex justify-content-between">
                                                                                        ...
                                                                                        <input
                                                                                            ...
                                                                                            onChange={(e) => {
                                                                                                ...
                                                                                                if (checked) {
                                                                                                    ...
                                                                                                    const dataNe = type.filter(item => item !== value)
                                                                                                    setType(dataNe)
                                                                                                }
                        ...
                        <>
                                    ...
                                    <div className="row">
                                        <div className="col-6">
                                            <button className={`skin-anatomy-upload rounded-pill mt-2 ${active ? "" : "disabled"}`}>
                                                ...
                                                <input type="file" onChange={handleSympImageUrl} accept="image/*" />

                                            </button>
                                            {sympImageError && <p style={{ color: "red" }}>{sympImageError}</p>}
                                        </div>
                                        <div className="col-6">
                            ...
                            <div className="row">
                                <div className="col-5">
                                    {
                                        sympImage.length > 0 &&
                                        sympImage.map((item, i) => <div key={i} className="d-flex mt-1">
                                ...
                                <div className="col-7">
                                    <div className="symptoms">
                                        {
                                            symptoms.length > 0 &&
                                            symptoms.map((symptom, index) => <div className='me-1 symptom d-inline-flex mb-2'>{symptom.symp}<i onClick={() => removeSymptom(index, symptom)} className="far fa-times-circle ms-1"></i></div>)
                                        }
                                    </div>
                                </div>
                            </div>
