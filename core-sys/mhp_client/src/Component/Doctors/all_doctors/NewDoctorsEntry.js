...
function NewDoctorsEntry() {
  ...
  const DoctorsEntry = (e) => {
    ...
    if (user?.isSuperAdmin) {
      if (isNaN(doctorsInput.saas_branch_id)) {
        toast.error("Branch is required");
        return;
      } else {
        formData.append("saas_branch_id", doctorsInput.saas_branch_id);
        formData.append(
          "saas_branch_name",
          orgBranch?.find(
            (item) => Number(item.id) === Number(doctorsInput.saas_branch_id)
          )?.name
        );
      }
    } else {
    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.data.status === 200) {
          ...
          if (res.data.doctor_fee[0]) {
            toast.error("Doctors Fee is required");
          }
        }
      })
      .catch((err) => {
  ...
  useEffect(() => {
    axios.get(`/title-dropdown`).then((res) => {
      if (res.data.status === 200) {
        ...
        setDoctors({ ...doctorsInput, dr_identity_no: res.data.DIN });
      }
    });
                      ...
                      <div className="col-6">
                        <div className="col-md-12 p-1 px-3">
                          ...
                          <input
                            ...
                            value={doctorsInput.dr_identity_no}
                            id="inputEmail4"
                            disabled
                          />
                        </div>
                        ...
                        {/* <div className="col-md-12 p-1 px-3">
                          ...
                          <input
                            ...
                            className="form-control form-control-sm "
                            onChange={handleInput}
                            value={doctorsInput.dr_family_name}
                            onKeyDown={(e) => {
                              if (e.key === 'Enter') {
                                document.getElementById('focusDrgiven1').focus();
                              }
                            }}
                            id="inputEmail4"
                          />
                        ...
                        <div className="col-md-12 p-1 px-3">
                          ...
                          <input
                            ...
                            className="form-control form-control-sm "
                            onChange={handleInput}
                            value={doctorsInput.dr_given_name}
                            id="focusDrgiven1"
                          />
                        </div>
                        ...
                        <div className="col-md-12 p-1 px-3">
                          ...
                          <input
                            ...
                            type="text"
                            onChange={handleInput}
                            value={doctorsInput.dr_middle_name}
                            className="form-control form-control-sm "
                            id="inputEmail4"
                          />
                        </div>
                        ...
                        <div className="col-md-12 p-1 px-3">
                          ...
                          <input
                            ...
                            type="text"
                            onChange={handleInput}
                            value={doctorsInput.dr_last_name}
                            className="form-control form-control-sm "
                            id="inputEmail4"
                          />
                        </div>
                        <div className="col-md-12 p-1 px-3">
                          ...
                          <input
                            ...
                            type="text"
                            onChange={handleInput}
                            value={doctorsInput.dr_preferred_name}
                            className="form-control form-control-sm "
                            id="inputEmail4"
                          />
                        </div>
                        <div className="col-md-12 px-3">
                          ...
                          <textarea
                            ...
                            onChange={handleInput}
                            value={doctorsInput.dr_address_line_1}
                        ...
                        <div className="col-md-12 p-1 px-3">
                          ...
                          <textarea
                            ...
                            onChange={handleInput}
                            value={doctorsInput.dr_address_line_2}
                            className="form-control"
                            id="exampleFormControlTextarea1"
                            rows="2"
                          ></textarea>
                        ...
                        <div className="col-md-12 p-1 px-3">
                          ...
                          <input
                            ...
                            className="form-control form-control-sm"
                            onChange={handleInput}
                            value={doctorsInput.dr_bmdc_reg_no}
                            id="inputEmail4"
                          />
                        </div>
                        <div className="col-md-12 p-1 px-3">
                      ...
                      <div className="col-6">
                        ...
                        <div className="col-md-12 p-1 px-3">
                          ...
                          <input
                            ...
                            className="form-control form-control-sm"
                            onChange={handleInput}
                            value={doctorsInput.dr_postal_code}
                            id="inputEmail4"
                          />
                        </div>
                        <div className="col-md-12 p-1 px-3">
                          ...
                          <input
                            ...
                            className="form-control form-control-sm"
                            onChange={handleInput}
                            value={doctorsInput.dr_home_phone}
                            id="inputEmail4"
                          />
                        </div>
                        <div className="col-md-12 p-1 px-3">
                          ...
                          <input
                            ...
                            className="form-control form-control-sm"
                            onChange={handleInput}
                            value={doctorsInput.dr_work_phone}
                            id="inputEmail4"
                          />
                        </div>
                        <div className="col-md-12 p-1 px-3">
                          ...
                          <input
                            ...
                            className="form-control form-control-sm"
                            onChange={handleInput}
                            value={doctorsInput.dr_mobile_phone}
                            id="inputEmail4"
                          />
                        </div>
                        ...
                        {user?.isSuperAdmin && (
                          <div className="col-md-12 p-1 px-3">
                            ...
                            <select
                              ...
                              name="saas_branch_id"
                              onChange={handleInput}
                              value={doctorsInput.saas_branch_id}
                              className="form-select col-form-label-sm font-size-patient"
                            >
                              <option selected>Select</option>
                        ...
                        <div className="col-md-12 p-1 px-3 d-flex">
                          ...
                          {doctorsInput.doctorImageUrl == false ? (
                            ...
                            <div className="docImage">
                              <img
                                src={doctorsInput.doctorImageUrl}
