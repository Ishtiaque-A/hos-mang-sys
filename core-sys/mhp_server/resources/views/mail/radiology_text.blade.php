...
<head>
    ...
    <title>Important Radiology Report from Mecro Health</title>
    <style>
        body {
...
<body>
    <div>
        <p>Dear Patient,</p>
        <p>We are writing to inform you that the attached document contains an important Report from Mecro Health.</p>
        ...
        <p>Best regards,</p>
        {{-- <p class="signature">{{$radiology->clinical_details->clinical_details_name?? 'N/A'}}</p> --}}
