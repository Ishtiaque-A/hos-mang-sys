...
<body>
    <div class="container">
        ...
        <div style="width: 100%; position: relative; height: 550px">
            ...
            >
                <ol >
                    @forelse($radiology as $radiologyItem)
                        <li>
                            {{ $radiologyItem['radiology_test_name'] ?? 'N/A' }}
                            <div style="width: 100%;">
                            <div
                            style="
                            padding: 10px;
                            ...
                            width: 100%;
                            "
                            > Note: {{ $radiologyItem['additional_test_name'] ?? 'N/A' }}
                            </div>
                            </div>
                        </li>
                        <br>
            ...
            <div class="other-info" >
                <p>
                    Test Type: {{$radiology[0]->test_type_name ?? 'N/A'}}
                </p>
                <p>
                    Symptom: {{$radiology[0]->symptom_name ?? 'N/A'}}
                </p>
            </div>
        </div>
        <br>
