...
class CreateMhpLabAgentReportDeliveryInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mhp_lab_agent_report_delivery_infos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('mhp_lab_agent_report_delivery_infos');
    }
}
