...
class CreateMhpMSCarvicalSpinesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mhp_m_s_carvical_spines', function (Blueprint $table) {
            $table->id();
        ...
        $table->string('carvicalHistoryValue')->nullable();
    ...
    {
        Schema::dropIfExists('mhp_m_s_carvical_spines');
    }
}
