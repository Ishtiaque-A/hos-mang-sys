...
class CreateMhpMSThoracoLumberSpinesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mhp_m_s_thoraco_lumber_spines', function (Blueprint $table) {
            $table->id();
            $table->string('patient_id')->nullable();
            
            $table->string('tenderOver')->nullable();
            $table->string('tenderOverL1ToL6')->nullable(); 
            $table->string('tendernessOver')->nullable(); 
            ...
            $table->string('thoracoHistoryValue')->nullable();
    ...
    {
        Schema::dropIfExists('mhp_m_s_thoraco_lumber_spines');
    }
}
