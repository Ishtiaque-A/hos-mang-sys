...
class CreateMhpLabAgentExpensesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mhp_lab_agent_expenses', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('mhp_lab_agent_expenses');
    }
}
