...
class CreateMhpGreatLabInvoiceDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mhp_great_lab_invoice_details', function (Blueprint $table) {
            $table->id();
            ...
            $table->boolean("report_approve_status")->default(0);
            $table->boolean("report_add_status")->default(0);
            $table->string("specimen_id")->nullable();
            $table->string("specimen_name")->nullable();
            $table->boolean("report_confiremd_status")->default(0);
    ...
    {
        Schema::dropIfExists('mhp_great_lab_invoice_details');
    }
}
